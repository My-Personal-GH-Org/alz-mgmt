...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "balajicn@hotmail.com"
...
management_group_settings = {
  ...
  policy_default_values = {
    ...
    # Allowed locations for Sovereign Landing Zones policies
    allowed_locations = [
      "$${starter_location_01}"
    ]

    # AMBA (Azure Monitoring Baseline Alerts) policy defaults
